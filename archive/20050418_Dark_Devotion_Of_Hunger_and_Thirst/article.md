# Dark Devotion: Of Hunger and Thirst

**Author:** Jay Moldenhauer-Salazar  
**Date:** April 18, 2005  
**Original URL (Wayback Machine):** <https://web.archive.org/web/20090601202842/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm96>

---

Greetings and welcome to the beginning of another preconstructed evolution!

Before we get there, though, a couple of notes about [last week](https://web.archive.org/web/20090603041828/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm95). People seemed to enjoy the “junk rare” look of my first Interlude. Actually, you all *flooded* me with e-mail piling on further suggestions. Most ideas fell into two buckets:
...
Okay, now let's get back to preconstructed decks. Here is the poll from [two weeks ago](https://web.archive.org/web/20090603041828/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm94):

Which deck is Jay going to play and change next?
Dark Devotion | 3311 | 38.8%
Rat's Nest | 2745 | 32.2%
Spiritcraft | 2479 | 29.0%
Total | 8535 | 100.0%
...
*(Full decklist with sideboard: `decklist_1_Dark_Devotion_v10.txt`; priced breakdown: `decklist_1_Dark_Devotion_v10_priced.md`)*
...
*4) Power*: Probably the best thing about Dark Devotion is its overall power level. In fact, the whole idea of the deck is to make creatures that are more than your opponent can handle. From common to uncommon to rare, the deck is using very respectable cards. Better options exist in Standard for a lot of what the deck is trying to do -- and some omissions like Ogre Recluse are bizarre -- but given that it's cobbled together from *Champions* and *Betrayers* only, you have to like what's in there. In fact, this is probably one of the only precons that is likely to not only retain its two rares (Yukora the Prisoner and Heartless Hidetsugu) but want more copies of each.
...
I started out with a pair of Bile Urchins while he started out with a pair of Goblin Strikers and a Bonesplitter. Things looked bad when he added Leonin Den-Guard to the mix, but I drew and played Hearth Kami. My Kami killed his axe, then Yukora the Prisoner entered the fray. My opponent failed to draw more equipment, so one by one his creatures became Yukora speed bumps. Frost Ogre joined in the fun, eating two Spikeshot Goblin chump-blockers and generally causing mayhem. Finally, an Oni Possession on Yukora overpowered his last Samurai of the Pale Curtain blocker to deal lethal damage.
...
His deck was trying to do something scary, putting artifacts like Talismans, Gemstone Array, Chromatic Sphere, and Darksteel Ingot into play along with Blinkmoth Urn. I cast an early Bile Urchin, then followed it up with Villainous Ogre and Deathcurse Ogre. Both of my Ogres met Swallowing Plague deaths, but I started drawing a lot of creatures at the same time my opponent started drawing a lot of land. My Urchin was joined by another Villainous Ogre, Initiate of Blood, and Scourge of Numai to end the game while my opponent had something like 40 counters on Gemstone Array. Whew.
...
I think, though I'm not yet sure, that Takenuma Bleeder is the best three-mana Ogre available in Standard right now. It certainly has the right power and toughness for three mana, and its drawback isn't debilitating even without the presence of a Demon. The one black mana makes it very easy to cast in a two-color deck as well. I'm pretty sure that of the existing cards in the deck, this is a four-copy gem.
...
*(Full decklist with sideboard: `decklist_2_Dark_Devotion_v11.txt`; priced breakdown: `decklist_2_Dark_Devotion_v11_priced.md`)*
...
The red was for burn and a few Samurai, but mostly it was a “super samurai” deck like the one above. I killed Nagao, Bound By Honor with Torrent of Stone, allowing my Takenuma Bleeder and Scourge of Numai to attack with abandon. His Battle-Mad Ronin plinked away at me for one damage a turn. Eventually he dropped Konda, Lord of Eiganjo which stalled my attack. His double (spliced) Glacial Ray killed my Bleeder, meaning I was taking damage from the Scourge. I drew Painwracker Oni with just enough time to eat the Scourge and attack for the win. Whew. Wayfarer's Bauble made an appearance early, helping me fix my mana.
...
Oni Possession is, surprisingly, my least favorite card still in the deck. Don't get me wrong: I like the +3/+3, I *love* the trample, and I can even see the use of turning things into Demons (though I once got myself into trouble by making an Ogre a Demon Spirit and thus losing a creature to Painwracker Oni). What I dislike is the “At the beginning of your upkeep, sacrifice a creature” bit. This deck never has a surplus of creatures -- often only one or two on the table at a time -- and so I have never found it acceptable to use Oni Possession as more than a finisher, a sort of Giant Growth for the last, lethal points of damage. Oni Possession is too slow and too expensive to be used as a Giant Growth, and so I can find better things for this card slot.
...
*(Full decklist with sideboard: `decklist_3_Dark_Devotion_v12.txt`; priced breakdown: `decklist_3_Dark_Devotion_v12_priced.md`)*
