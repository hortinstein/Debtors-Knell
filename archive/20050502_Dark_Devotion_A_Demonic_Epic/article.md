# Dark Devotion: A Demonic Epic

**Author:** Jay Moldenhauer-Salazar  
**Date:** May 2, 2005  
**Original URL (Wayback Machine):** <https://web.archive.org/web/20090601202842/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm98>

---

I can almost hear the Online Media department guys who have been filling in for Scott Johns during his paternity leave. What I hear is them sharpening their voodoo pins.
...
Everyone remember what we're doing? If not, [check out the first week](https://web.archive.org/web/20090603041722/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm96) of this experiment. Be sure to remind yourself of the Guidelines and why I'm doing this evolution (hint: think fun, respectable, budget). Also remind yourself that I'm bound to make changes you wouldn't make, which only highlights the fun of deckbuilding.
...
*(Full decklist with sideboard: `decklist_1_Dark_Devotion_v14.txt`; priced breakdown: `decklist_1_Dark_Devotion_v14_priced.md`)*
...
Let me be clear: Overblaze is not bad for this deck. Even without Heartless Hidetsugu, you can swing a game with one unblocked Yukora or Ogre Recluse with Overblaze. Indeed, Overblaze is neat because it's one of those “Oops ... I win!” cards. It is red's Might of Oaks. Just like Might of Oaks, however, Overblaze is also what a lot of people call a “win more” card. The times when Overblaze ends a game is probably a game you're already winning. Overblaze would be better used as simple red burn, which can kill creatures directly or be aimed at an opponent's face. It has stuck around so long because it's a nice complement to big fatties, but when trimming the final cards it has no place remaining in a deck not trying to abuse the combination with Heartless Hidetsugu.
...
Apparently Hearth Kami spit in someone's tea, because he's been dropped from almost every decklist I've seen on the Message Boards. I think he's great. First, he's aggressive, efficient, early offense for a deck with no early game to speak of. Second, he is right behind Ogre Recluse as the reason to keep the deck from drifting monoblack. Without red, the deck needs to rely on discard to get rid of things such as Sword of Fire and Ice, Umezawa's Jitte, Ensnaring Bridge, Vedalken Shackles, and Sun Droplet. These cards wreck a fattie deck. Decks online use these cards. A lot. Hearth Kami can thus win you otherwise unwinnable games and it is almost never a dead card. He's not a very elegant solution in the deck since he is neither Ogre nor Demon, but I have come to really appreciate Hearth Kami as the best available solution in Standard. I can't think of a good reason to keep the fourth copy out of the decklist.
...
*IN*: 1 Seizan, Perverter of Truth
...
You may recall that I think instant-speed removal is important in a deck sporting Ogre Recluse. You may also recall that one of the two reasons I want removal is to clear weenie swarms away. A perfect series of events, it seems to me, is playing Hideous Laughter at the end of my opponent's turn then charging in with an army of fat for the win.
...
*(Full decklist with sideboard: `decklist_2_Dark_Devotion_v15.txt`; priced breakdown: `decklist_2_Dark_Devotion_v15_priced.md`)*

Looky looky ... I want red for Ogre Recluse and Hearth Kami, and those are currently the only two red cards in the deck. Keen.
...
My opponent had two quick Orochi Rangers to match my two quick Hearth Kami. He also found Sakura-Tribe Elder and Orochi Sustainer. I played Yukora, the Prisoner and was off to the races. He tried to mass-block my Yukora, figuring if it died it would also kill my Kami, but I used Rend Flesh on one of the blockers to decimate his side of the board. Ogre Recluse followed and I lay 14 points of offense for two turns to finish the game.
...
Rend Flesh was very kind to me and stayed hidden this game. Instead, Ogre Recluse and Yukora, the Prisoner came into play on turns three and four. My opponent had a Jetting Glasskite and Quillmane Baku as chump-blockers, but I was showing too much offense. A Bloodthirsty Ogre joined the fray, then Blood Speaker. My opponent stayed alive with Eye of Nowhere and three Vital Surges, but was eventually crunched beneath Yukora's bloody boot.
...
Another reason for choosing Ogre Marauder over Bloodthirsty Ogre is that, as I've noted, my deck is fairly light on Demons. That is, I have seven Demons to go along with fourteen Ogres. Even with Blood Speaker, it's asking a lot of a one-toughness creature to stick around long enough to both accumulate devotion counters and use them on the off-chance a Demon appears. The inclusion of Hideous Laughter as removal means that I am putting even more strain on Bloodthirsty Ogre's survivability.
...
Doing the Mana Math Black Cards 4 Rend Flesh = 4.0 4 Takenuma Bleeder = 4.0 4 Ogre Marauder = 6.0 2 Blood Speaker = 2.0 4 Scourge of Numai = 4.0 3 Hideous Laughter = 4.5 2 Yukora = 3.0 1 Seizan = 1.5 Total Black Score = 29.0 Red Cards 4 Hearth Kami = 4.0 4 Ogre Recluse = 4.0 Total Red Score = 8.0
...
This deck is probably more expensive to build than [Club Ninja](https://web.archive.org/web/20090603041722/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm94) just because of the sheer volume of uncommons involved. The lone Seizan won't break the bank, but it isn't cheap either. Still, I feel comfortable calling this deck “fun, respectable, and budget” which are my goals with each of these preconstructed experiments.
...
I didn't speculate about a sideboard with Club Ninja and received a ton of e-mail wishing I had. As a result, I'll give you my best guess as to where I would start thinking about sideboarding for my new deck anticipating a, say, [Friday Night Magic](https://web.archive.org/web/20090603041722/https://www.wizards.com/Magic/Magazine/Article.aspx?x=events/magic/fnm) or 8-person online Standard tourney.
...
Monoblue decks seem to be on the rise in the post-Affinity Standard, and Vedalken Shackles is a card that can single-handedly (heh ... get it?) ruin my deck's day. Hearth Kami helps, but nothing says “Pththththth!” like Boil. There is nothing in monoblack that can hurt a blue deck as much as Boil, so it feels like a must for any deck with Mountains.
...
**Budgetary Black by Killer Shrike**
...
*(Full decklist with sideboard: `decklist_4_Budgetary_Black_by_Killer_Shrike.txt`; priced breakdown: `decklist_4_Budgetary_Black_by_Killer_Shrike_priced.md`)*
...
*(Full decklist with sideboard: `decklist_5_Kurgoyf_by_treyburg_53.txt`; priced breakdown: `decklist_5_Kurgoyf_by_treyburg_53_priced.md`)*
...
*(Full decklist with sideboard: `decklist_6_Oni-Potent_by_Nate_Heiss.txt`; priced breakdown: `decklist_6_Oni-Potent_by_Nate_Heiss_priced.md`)*
