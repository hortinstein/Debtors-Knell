# The Great Dredge Contest! (Part 1 of 3)

**Author:** Ben Bleiweiss  
**Date:** July 16, 2007  
**Original URL (Wayback Machine):** <https://web.archive.org/web/20090601202842/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/bb121>

---

Hello everyone, and welcome back to Building on a Budget! [Three weeks ago](https://web.archive.org/web/20090603042749/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/bb118), I held a contest in my column. The challenge? Build a budget dredge deck for 30 tickets or less using the following pool of cards:
...
The response for this contest was overwhelming! There were over a hundred deck lists posted in the [forums](https://web.archive.org/web/20090603042749/http://boards1.wizards.com/showthread.php?t=872308) of the Completely from Scratch article, and the creativity displayed was top notch. Out of a card pool of just 80 cards, there were no less than *twelve* distinct archetypes that people came up with for this challenge! Everyone did a great job of contributing, so give yourselves a round of applause (or the internet equivalent). Bravo!

Forest

On the original list, there were two problems. The first was that I accidentally listed Islands instead of Forests as one of the basic land types. This was corrected in the forums by our very own Kelly Digges, and so all entries that contained basic Forests were fine. The second was that Golgari Rot Farm was accidentally left off of the list of usable lands somewhere along the process between submission and publication of my article. To be fair to everyone, decks that used Golgari Rot Farm were disqualified from the contest—even though I intended for them to be used, they weren't on the list, there was no indication that they were allowed to be used, and it wouldn't be right to let some people use them, and others not.
...
*(Full decklist with sideboard: `decklist_10_Pablofactors_WG_Glare_Beatdown.txt`; priced breakdown: `decklist_10_Pablofactors_WG_Glare_Beatdown_priced.md`)*
...
Ben says: This deck does a lot of things right—it has enough early dredge enabling (Llanowar Mentor, Greenseeker, Fa'adiyah Seer) to make sure that you can be dredging by turn two. The last thing you want is to be stuck with a dredge card (or Bridge from Below) in your hand with no way to get it to the bin.
...
*(Full decklist with sideboard: `decklist_11_Camlok80s_Jolreal_Land_Destruction.txt`; priced breakdown: `decklist_11_Camlok80s_Jolreal_Land_Destruction_priced.md`)*
...
*(Full decklist with sideboard: `decklist_12_DELangleys_Black-Green-White_Gruntcursion.txt`; priced breakdown: `decklist_12_DELangleys_Black-Green-White_Gruntcursion_priced.md`)*
...
*(Full decklist with sideboard: `decklist_1_Tteks_Bridge_From_Below_Dredge.txt`; priced breakdown: `decklist_1_Tteks_Bridge_From_Below_Dredge_priced.md`)*
...
*(Full decklist with sideboard: `decklist_2_Bloosh123s_BGW_Reanimator_Toolbox.txt`; priced breakdown: `decklist_2_Bloosh123s_BGW_Reanimator_Toolbox_priced.md`)*
...
Ben says: Wow, I really like everything that was put into this deck—with a full three point four tickets left to spare, XmontyX managed to cram Persecute, Mystic Enforcer, Loxodon Hierarch, Greater Good, Teneb, the Harvester, and Blazing Archon into one deck. In addition, he made it so that most of these cards could be tutored for with Dimir House Guard—which also goes to feed Golgari Grave-Troll.
...
*(Full decklist with sideboard: `decklist_3_Ankous_Mono-Black_Fatties.txt`; priced breakdown: `decklist_3_Ankous_Mono-Black_Fatties_priced.md`)*
...
*(Full decklist with sideboard: `decklist_4_Sam111111s_BG_Beatdown.txt`; priced breakdown: `decklist_4_Sam111111s_BG_Beatdown_priced.md`)*
...
*(Full decklist with sideboard: `decklist_5_XmontyXs_BGW_Toolbox.txt`; priced breakdown: `decklist_5_XmontyXs_BGW_Toolbox_priced.md`)*
...
*(Full decklist with sideboard: `decklist_6_Chiefbandits_BGW_Control.txt`; priced breakdown: `decklist_6_Chiefbandits_BGW_Control_priced.md`)*
...
*(Full decklist with sideboard: `decklist_7_Zachary74s_GW_Cards-in-Hand.txt`; priced breakdown: `decklist_7_Zachary74s_GW_Cards-in-Hand_priced.md`)*
...
*(Full decklist with sideboard: `decklist_8_Endymion2s_WG_Threshold.txt`; priced breakdown: `decklist_8_Endymion2s_WG_Threshold_priced.md`)*
...
*(Full decklist with sideboard: `decklist_9_Suicidal_Hamsters_WG_Glare_Control.txt`; priced breakdown: `decklist_9_Suicidal_Hamsters_WG_Glare_Control_priced.md`)*
...
Ben says: Ladies and gentlemen, we have our winner! This is the deck I'm going to start evolving next week—this deck just seems like it's got so much going on! Dredge works really well with Mortivore, Mystic Enforcer and Nether Traitor (since you get to throw them into the graveyard for free, and bring them back once something dies). It has mana fixing (bouncelands, Greenseeker), removal (Mortify, Putrefy), card advantage (Life from the Loam, Nether Traitor with Dredge), and best of all, an engine!
