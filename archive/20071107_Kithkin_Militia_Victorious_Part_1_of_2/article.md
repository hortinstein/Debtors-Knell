# Kithkin Militia Victorious! (Part 1 of 2)

**Author:** Ben Bleiweiss  
**Date:** November 7, 2007  
**Original URL (Wayback Machine):** <https://web.archive.org/web/20090601202842/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/bb137>

---

Building on a Budget is dedicated to making decks that cost 30 tickets or less on Magic Online . Weekly deck testing is done using Magic Online . This week's format? Standard. This means only Coldsnap , Time Spiral , Planar Chaos , Future Sight , Tenth Edition , and Lorwyn are allowed!

Hello everyone, and welcome to Building on a Budget! This week, we'll be evolving the Kithkin Militia Theme Deck, based on the voting by you, the readers! I broke down the contents of the deck [a couple of weeks ago](https://web.archive.org/web/20090603042841/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/bb135) and then held a vote to see how I should evolve the deck. Here were the results!

How should Ben evolve the Kithkin Militia Deck?
Straight Kithkin, with no sub-theme. | 2947 | 33.8%
Kithkin and Giants. Giants like helping their little friends! | 2697 | 30.9%
Kithkin / Soldiers. Let's see how big those guys can get! | 2400 | 27.5%
Kithkin and Rebels. This would reallllly gut the Kithkin Theme deck though! | 679 | 7.8%
Total | 8723 | 100.0%
...
Angry Mob So imagine my surprise when I logged into my account to start playtesting for this week, and found that, oops! someone had forgotten to load up any of the *Lorwyn* cards into my account! This left me with three choices:

1. Don't write my column this week, and let Scott Johns and Kelly Digges take turns playing "Human Piñata" with my strung-up body.
2. Switch this column with another one that didn't involve *Lorwyn* cards, which would make the "Reality Fracture" riots of 2006 seems like a cakewalk.
3. Dedicate this column to one Zachary at Iowa State, jump onto my personal **Magic Online** account, and write this column by buying and tracking down all of the cards needed on my own time and money!
...
*(Full decklist with sideboard: `decklist_1_Kithkin_Militia.txt`; priced breakdown: `decklist_1_Kithkin_Militia_priced.md`)*
...
*(Full decklist with sideboard: `decklist_2_Kithkin_Militia_2.txt`; priced breakdown: `decklist_2_Kithkin_Militia_2_priced.md`)*
...
*(Full decklist with sideboard: `decklist_3_Kithkin_Militia_3.txt`; priced breakdown: `decklist_3_Kithkin_Militia_3_priced.md`)*
...
If you've been following the coverage of State Championships or Grand Prix–Krakow, you'll recognize this deck as one of the top-tier Standard decks out there right now. You can see the list played by Matej Zatlkaj, Top 8 Finisher at Grand Prix–Krakow this past weekend, [here](https://web.archive.org/web/20090603042841/https://www.wizards.com/Magic/Magazine/Events.aspx?x=mtgevent/gpkra07/top8decks).
...
*(Full decklist with sideboard: `decklist_4_Kithkin_Militia_4.txt`; priced breakdown: `decklist_4_Kithkin_Militia_4_priced.md`)*
