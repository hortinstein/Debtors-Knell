...
**Original URL (Wayback Machine):** <https://web.archive.org/web/20090601202842/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm119>

---

It's interesting that a few people on the Message Boards wrote that my evolved *9th Edition* [preconstructed experiment](https://web.archive.org/web/20090603042221/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm118) is turning out to be a “mess” and “lacks focus.” This is not to say that the negative feedback was in the majority, but I think a lot of people looked at the deck last week and thought it was underpowered, fragmented, or just plain boring. My guess is that these people didn't try playing the deck or their own variation on it.
...
*Pain Kami* - GodofAtheism ended up with a decklist very similar to mine in his own tinkering. Whereas I used Threaten and Nantuko Husk, he used Night's Whisper, Highway Robber, and Pain Kami. I like his reasoning about Pain Kami when he says, “along with Hearth Kami, he gives me the chance to react to something at instant speed, something this deck otherwise lacks the ability to do. I have found this ability very important in many situations.”
...
I don't know why I kept playing single duels instead of matches when in the latter stages of testing the deck. I should have messed around in the Tourney Decks room just to see how my deck performed. Since I didn't, I'm left with a speculative sideboard without testing behind it. I'm not sure of the numbers distribution, because that distribution is based on what cards I want to drop and add in each matchup. Still, here is how I would begin thinking about a sideboard for something like a [Friday Night Magic](https://web.archive.org/web/20090603042221/https://www.wizards.com/Magic/Magazine/Article.aspx?x=events/magic/fnm):

*Sideboard*: 4 Coercion

Against decks without creatures, I'm going to want to take out Cruel Edict and Threaten. One card that would certainly get added in their place is Coercion. I know, I know... why not Distress? Well, it's possible that I could use Distress on Turn 2, but it's also possible that I wouldn't have the BB mana to cast it until the fourth or fifth turn. Coercion is a turn slower than Distress, but I will almost always be able to cast it. Mind Rot is another consideration, but with only Ravenous Rats as backup, it's not likely to hit my opponent's most critical cards.

*Sideboard*: 4 Boiling Seas

This deck is probably one of the only ones that is happy Boil is out of the Core Set and replaced by Boiling Seas. For any deck with a lot of Islands, this should be a game-winner if it resolves.
...
Remember my recent plea to [get the *9th Edition* painlands](https://web.archive.org/web/20090603042221/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm115)? I imagine I'll get pretty repetitive over the next year in these “Adding Money” sections. If you can at all afford them and want to give a deck like this a try, absolutely include Sulfurous Springs. The deck's chief weakness is mana consistency, and the reason to add painlands is to achieve better mana consistency. Dropping two Swamps and two Mountains for four Springs is an absolute no-brainer. If my conscience could justify them in this column, they would surely be in the deck.

*Solemn Simulacrum*

Solemn Simulacrum

Solemn Simulacrum won't be around in Standard for long, so it's probably not worth going out and finding them if they're not already in your collection and you play all your matches using that format. If you do have them, though, I can't think of a deck that loves Solemn Simulacrum much more than this one. It's slow, yes, but it smoothes mana, thins land, draws cards, and is a perfect target for Gravedigger or Zombify. I love the Simulacrum, and will be sorry to see it leave Standard once *Ravnica: City of Guilds* becomes legal.

*Rare Bad-Boys*

A lot of people see “reanimation” as a deck theme and automatically think fatties. This deck is a good example of utility-based reanimation without a reliance on getting big meanies into my graveyard. That said, big meanies are certainly worthy of a spot as the deck's “finisher” if you aren't partial to Magnivore. Kokusho, the Evening Star, KageMaro, First to Suffer, Ryusei, the Falling Star, Ink-Eyes, Servant of Oni, and the aforementioned Mortivore might all shine as the deck's cleanup man. In addition, Nezumi Shortfang could easily replace Ravenous Rats, and Duplicant or Triskelion could work well. Just remember that if you start adding five- and six-mana cards to the deck you're like to run into even more mana problems.
...
It's a secret I've been keeping for months! You all heard that [*Mirage* is coming to ***Magic** Online*](https://web.archive.org/web/20090603042221/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/bs15), and that the online release of the set is also going to include four preconstructed theme decks. One of those theme decks is being designed by Markus Pettersson, the winner of the "[Design a Mirage Theme Deck](https://web.archive.org/web/20090603042221/https://www.wizards.com/Magic/TCG/Article.aspx?x=magic/magiconline/article080405)" ***Magic** Online* tournament. Starting later this week, you'll have a chance to design another deck in “[You Make The Card](https://web.archive.org/web/20090603042221/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/ymtc38)” style. Once they know the other three decks, **Magic** R&D will design the fourth to fill out the set.
...
**Rares**: Benthic Djinn; Purraj of Urborg
...
**Rares**: Shallow Grave; Spirit of the Night
...
**Rares**: Lure of Prey; Rock Basilisk

---

Now it's up to you to decide which deck will be my own home-grown preconstructed deck.

Which deck should Jay make? Deck #1 (Blue/Black) Deck #2 (Black) Deck #3 (Red/White) Deck #4 (Green/Red) | Which deck should Jay make? | Deck #1 (Blue/Black) Deck #2 (Black) Deck #3 (Red/White) Deck #4 (Green/Red) | Deck #1 (Blue/Black) Deck #2 (Black) Deck #3 (Red/White) Deck #4 (Green/Red)
Which deck should Jay make?
Deck #1 (Blue/Black) Deck #2 (Black) Deck #3 (Red/White) Deck #4 (Green/Red) | Deck #1 (Blue/Black) Deck #2 (Black) Deck #3 (Red/White) Deck #4 (Green/Red)
Deck #1 (Blue/Black) Deck #2 (Black) Deck #3 (Red/White) Deck #4 (Green/Red)
