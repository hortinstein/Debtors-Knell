...
*(Full decklist with sideboard: `decklist_1_Dead_World_Redux.txt`; priced breakdown: `decklist_1_Dead_World_Redux_priced.md`)*

**How The Deck Works**

If you followed the deck evolution that led me to [Dead World](https://web.archive.org/web/20090603041217/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm119), then you probably feel like you understand how this deck is supposed to play. There are some key differences to the two decklists, though, enough that they end up acting really differently. Dead World was about creature reanimation first, with the Sorcery theme as a heavy support plan. The Redux version cares a lot less about its creatures and a lot more about sorceries.
...
Believe it or not, when I write a “Paths Not Taken” section at the end of a deckbuilding series like Dead Again or [Thief of Time](https://web.archive.org/web/20090603041217/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm114), I actually mock-up decklists for each idea. Usually the decklists are too unclean and cursory to publish, but sometimes I'm intrigued enough to play the deck in my spare time. When I wrote my “[Budget Dimir](https://web.archive.org/web/20090603041217/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm134)” article (and let's face it, those budget guild articles are just expanded “Paths Not Taken” sections), one such first-draft deck that became a hobby was based on Hunted Phantasm.
...
*(Full decklist with sideboard: `decklist_2_Night_Phantom.txt`; priced breakdown: `decklist_2_Night_Phantom_priced.md`)*
...
For as long as good, rare, multilands are in Standard, they will be my [first recommendation](https://web.archive.org/web/20090603041217/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm133) in any two-color “Adding Money” section. The two key elements of this deck have {U}{U} and {B}{B} in their mana costs, so any all mana-fixing is welcome.
...
*(Full decklist with sideboard: `decklist_3_Blind_Faith.txt`; priced breakdown: `decklist_3_Blind_Faith_priced.md`)*
...
Although this article is already plenty long, I would be remiss if I signed off today without dubbing my [modified Golgari draft deck](https://web.archive.org/web/20090603041217/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm138). Here are the names from last week's Boards that I most enjoyed:
...
*(Full decklist with sideboard: `decklist_4_Moldermort.txt`; priced breakdown: `decklist_4_Moldermort_priced.md`)*
