...
If you need a refresher, [go here](https://web.archive.org/web/20090603042354/https://www.wizards.com/Magic/Magazine/Article.aspx?x=mtgcom/daily/jm112) and read about why I'm focusing on Blood Clock, then go here to see where the deck has meandered up until today. What you'll see is that I took a Monoblack Blood Clock deck focused on discard and Thief of Hope and added Choice of Damnations and Green for mana-acceleration, yielding this decklist:
...
*(Full decklist with sideboard: `decklist_1_Black_Clock_v20.txt`; priced breakdown: `decklist_1_Black_Clock_v20_priced.md`)*

Last week I played ten games with this decklist and made the following observations:

- My deck is prone to mana-flooding.
- My deck can't deal with Kodama of the North Tree.
- My deck can't deal with Umezawa's Jitte.
- My deck has a hard time with fliers.
- Blood Clock and Choice of Damnations are real skill-testers for my opponents.
- I love the Green acceleration.
- I still love Choice of Damnations and Thief of Hope.
- I'm a little dubious of Wicked Akuba because it seems like the one true beatdown card in the deck.
- I haven't drawn Death of a Thousand Stings once since dropping to a single copy.
...
*(Full decklist with sideboard: `decklist_2_Black_Clock_v21.txt`; priced breakdown: `decklist_2_Black_Clock_v21_priced.md`)*
...
*(Full decklist with sideboard: `decklist_3_Black_Clock_v22.txt`; priced breakdown: `decklist_3_Black_Clock_v22_priced.md`)*
...
*(Full decklist with sideboard: `decklist_4_Black_Clock_v23.txt`; priced breakdown: `decklist_4_Black_Clock_v23_priced.md`)*
